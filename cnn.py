...
image = tf.reshape(conv2d(h_pool1, W_conv2) + b_conv2,[-1,28,28,1])
...
for i in range(20000):
    ...
    if i%100 == 0:
        ...
        sumarr = sess.run(merged_summary, feed_dict={x: batch[0], y_: batch[1], keep_prob: 0.5})
        file_writer.add_summary(sumarr, i)
